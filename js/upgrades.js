...
const PERMANENT_UPGRADES = [
    ...
    { id:'p_crystal',name:'Crystal Finder',   desc:'+10% chance/rank for +1 bonus room crystal.',maxRank:3, costPerRank:[1,2,3],      icon:'icon_crystal',      apply(){ /* Handled in Game.awardRoomClearCrystals() */ } },
];
